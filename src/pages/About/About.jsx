...
import vidAbout from "../../assets/video/about-video.mp4";
        ...
        <>
            <div className="max-w-[1140px] mx-auto px-4 mt-[125px]">
                <div>
                    ...
                    <h2 className="text-sub-primary text-3xl md:text-4xl max-w-[732px] font-semibold">
                        We are a leading beauty clinic that has been around
                        since 2002
                    </h2>
                    <p className="text-desc text-base font-normal tracking-widest">
                    ...
                    <div>
                        <video
                            src={vidAbout}
                            controls
                            className="rounded-[50px] mt-[58px] "
                            loop
                        ></video>
                        {/* <button>
            ...
            >
                <span className="text-[#ABB4FF] font-semibold ">
                    Business Slogan
                </span>
            ...
            <div>
                <div className="max-w-[1140px] mx-auto px-4 ">
                    <div className="text-center mt-[134px]">
                        ...
                        <h2 className="text-subPrimary mt-[10px] text-4xl font-semibold leading-[125%]">
                            Well-known agencies
                        </h2>
                        <p className="text-desc mt-[19px] text-base font-normal tracking-widest">
                            Lorem ipsum dolor sit amet, consectetur adipiscing
                            elit
                        </p>
                    </div>

                    <div className="flex justify-center items-center gap-[60px] mt-[94px] flex-wrap">

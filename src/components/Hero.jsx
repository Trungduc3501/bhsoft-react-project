            ...
            <div className="px-4">
                ...
                <div className="flex justify-between items-center gap-[22px]  w-full max-w-[1140px] mx-auto mt-[159px]">
                    <div className="ml-[39px]">
                        ...
                        <button className="mt-7 px-[41px] py-[16px] bg-[#FF64AE] rounded-[50px] text-white text-base font-semibold tracking-widest hover:text-[#091156] hover:opacity-90 ease-in-out duration-500  ">
                            More Details
                        </button>
                    </div>
                    <div>
